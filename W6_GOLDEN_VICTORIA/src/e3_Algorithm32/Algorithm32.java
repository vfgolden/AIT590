...
/**
 * Homework Implementation of Book Algorithm 3.2
 * 
 * @author Victoria Golden
 *
 */
public class Algorithm32<Key extends Comparable<Key>, Value> {
	...
	public Algorithm32(int capacity) {
	...
	public static void testMethod(String key) {
		Algorithm32<String, String> array = new Algorithm32<String, String>(10);
	...
	public static void main(String[] args) {
		System.out.println("Exercise 3: Implement and test Algorithm 32 by Victoria Golden\n");

		String[] alphabet = { "A", "B", "C", "D", "E", "F", "G", "H", "J", "K", "L", "M", "N", "O", "P", "Q", "R", "S",
				"T", "U", "V", "W", "X", "Y", "Z" };
		for (int i = 0; i < alphabet.length; i++) {
			testMethod(alphabet[i]);
		}
		...
		System.out.println("\nExercise 4: 3.1.1-Compute GPA by Victoria Golden");
